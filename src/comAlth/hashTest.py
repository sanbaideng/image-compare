...
lenna400 = PIL.Image.open('9.jpg')
lenna512 = PIL.Image.open('81.jpg')
lennaText = PIL.Image.open('82.jpg')
...
print('phash leanna512 compare leannatext : ',
      (p1 - p2) / len(p1.hash) ** 2, end='\n\n')
...
print('whash leanna512 compare leannatext : ',
      (w1 - w2)/len(w1.hash)**2, end='\n\n')
...
print('average_hash leanna512 compare leannatext : ',
      (a1 - a2)/len(a1.hash)**2, end='\n\n')
